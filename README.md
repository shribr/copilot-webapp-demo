...
3. Remove the "apiKey": "<redacted>" entry from the vector search index json if it exists. Don't just remove the value "<redacted>". Remove the entire property.
...
8. Azure AI Project / Machine Learning Workspace:
